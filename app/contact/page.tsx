export const metadata = {
  ...
  description: "Get in touch with Masar Al Amana for all your government service needs in UAE. Visit our office, call us, or send an email.",
};
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-black !text-white mb-4 tracking-tight">
              Contact <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C5A854] to-[#D4AF37]">Masar Al Amana</span>
            </h1>
            <p className="text-lg md:text-xl text-white/80 font-medium max-w-2xl">
              Dedicated support for all your government and business procedures across the UAE.
            </p>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-1/3 space-y-6">
              <div className="bg-white p-10 rounded-[40px] shadow-2xl shadow-black/5 border border-gray-100 relative overflow-hidden group">
                ...
                <h3 className="text-2xl font-black mb-8 text-text-dark">Quick Contact</h3>
                ...
                <div className="space-y-8 relative z-10">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="font-black text-text-dark text-sm uppercase tracking-widest mb-1">Our Office</h4>
                      <p className="text-text-gray font-medium leading-relaxed">
                        Shop No. 5, Al Qusais Industrial 2,<br/>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="font-black text-text-dark text-sm uppercase tracking-widest mb-1">Phone Inquiry</h4>
                      <p className="text-text-gray font-black text-lg">
                        <a href="tel:+971556541988" className="hover:text-uae-green transition-colors">+971 5565 41988</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h4 className="font-black text-text-dark text-sm uppercase tracking-widest mb-1">Email Support</h4>
                      <p className="text-text-gray font-medium">
                        <a href="mailto:masaralamana@gmail.com" className="hover:text-uae-green transition-colors">masaralamana@gmail.com</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-8 border-t border-gray-100 mt-8">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-black text-text-dark uppercase tracking-widest">Available Now</span>
                    </div>
                    <p className="text-text-gray text-xs mt-2 font-medium">Mon-Sat: 09:00AM - 06:00PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-2/3">
              <div className="bg-white p-6 lg:p-16 rounded-[40px] shadow-2xl shadow-black/5 border border-gray-100">
                <h3 className="text-4xl font-black mb-10 text-text-dark tracking-tight">Send Us a <span className="text-uae-green">Message</span></h3>
                <form className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label htmlFor="name" className="text-sm font-black text-text-dark uppercase tracking-widest ml-1">Full Name</label>
                      <input 
                        type="text" 
                        id="name" 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-sm font-black text-text-dark uppercase tracking-widest ml-1">Email Address</label>
                      <input 
                        type="email" 
                        id="email" 
                        className="w-full px-6 py-5 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-uae-green/10 outline-none transition-all font-medium text-text-dark"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                     <div className="space-y-2">
                      <label htmlFor="phone" className="text-sm font-black text-text-dark uppercase tracking-widest ml-1">Phone Number</label>
                      <input 
                        type="tel" 
                        id="phone" 
                        className="w-full px-6 py-5 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-uae-green/10 outline-none transition-all font-medium text-text-dark"
                    ...
                    <div className="space-y-2">
                       <label htmlFor="service" className="text-sm font-black text-text-dark uppercase tracking-widest ml-1">Service Required</label>
                       <select 
                         id="service" 
                       ...
                       >
                         ...
                         <option value="pro-services">Professional PRO Services</option>
                         <option value="local-sponsor">Local Sponsor Arrangement</option>
                         <option value="real-estate">Real Estate & Rental Advisory</option>
                         <option value="municipality">Municipality Services</option>
                         <option value="medical">MOH, DHA & Medical</option>
                         <option value="legal-translation">Legal Translation</option>
                         <option value="medical-typing">Medical Typing Service</option>
                         <option value="emirates-id">Emirates ID Application</option>
                         <option value="attestation">Attestation Services</option>
                         <option value="utilities">Utilities Approvals</option>
                         <option value="trademark">Trade Name & Trademark</option>
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-sm font-black text-text-dark uppercase tracking-widest ml-1">Your Message</label>
                    <textarea 
                      id="message" 
                      rows={4} 
                  ...
                  <button type="button" className="group w-full md:w-auto bg-uae-green text-white px-12 py-5 rounded-2xl font-black text-lg transition-all shadow-xl shadow-uae-green/20 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3">
                     Send Inquiry
