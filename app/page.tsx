          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-24">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 px-6 md:px-0 lg:gap-6 w-full sm:w-auto">
                <a href="tel:+971556541988" className="group flex items-center justify-center lg:justify-start gap-4 bg-white border border-gray-100 shadow-[0_15px_35px_rgba(0,0,0,0.08)] px-6 lg:px-8 py-4 lg:py-5 rounded-2xl hover:border-uae-green/30 hover:shadow-xl transition-all duration-300 w-full sm:w-auto">
                  ...
                  <div className="text-left">
                    ...
                    <div className="font-extrabold text-text-dark text-lg lg:text-xl">+971 55 654 1988</div>
                  </div>
                </a>
              </div>
            </div>
